...
// Part 2:
// Keep connecting globally closest pairs (each unordered pair considered once).
// The moment DSU reaches 1 component, the current edge is the "last needed".
// Output x[a] * x[b] for that edge.

...
fn main() {
    ...
    // CPU stress: many parallel solves
...
/// Day 6 Part 2: cephalopod math, read columns top->bottom inside each problem.
fn solve(input: &str) -> i64 {
    ...
    // Grid of chars, padded with spaces
    ...
    // Operator row (bottom-most row with '+' or '*')

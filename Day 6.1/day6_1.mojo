...
def solve(text: String) -> Int:
    ...
    # Find problem ranges: contiguous non-blank columns
    var starts = [Int(0)]
    var ends = [Int(0)]
    ...
    # For each problem, find operator and numbers
    var p: Int = 0
    while p < prob_count:
        ...
        # Collect numbers above operator row
        var nums = [Int(0)]
        var num_count: Int = 0
...
def main():
    ...
    print(answer)
    print("Single run time (Mojo, Day 6.1):", elapsed_ms, "ms")
